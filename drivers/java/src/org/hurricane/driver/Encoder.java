...
public class Encoder {
    public static void encodeDouble(Double data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(70));
        Long value = Double.doubleToLongBits(data);
        stream.write(Utils.packNumber(value));
    }

    public static void encodeBitBinary(BitBinary data, StreamInterface stream) throws IOException {
    ...
    public static void encodeAtomCacheRef(AtomCacheRef data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(82));
        stream.write(Utils.toBytes((int) data.mValue));
    }

    public static void encodeByte(Byte data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(97));
        stream.write(Utils.toBytes((int) data));
    }

    public static void encodeShort(Short data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(98));
        stream.write(Utils.packNumber(data.intValue()));
    }

    public static void encodeInteger(Integer data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(98));
        stream.write(Utils.packNumber(data));
    }

    public static void encodeLong(Long data, StreamInterface stream) throws IOException {
    ...
    public static void encodeBigInteger(BigInteger data, StreamInterface stream) throws IOException {
    ...
    public static void encodeAtom(Atom data, StreamInterface stream) throws IOException {
        ...
        if (bytes.length < 0xf) {
            ...
            stream.write(
                Utils.packNumber(new Integer(bytes.length).shortValue())
            );
        }
        stream.write(bytes);
    }

    public static void encodeReference(Reference data, StreamInterface stream) throws IOException {
    ...
    public static void encodePort(Port data, StreamInterface stream) throws IOException {
    ...
    public static void encodePid(Pid data, StreamInterface stream) throws IOException {
    ...
    public static void encodeTuple(Tuple data, StreamInterface stream) throws IOException {
    ...
    public static void encodeNil(Nil data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(106));
    }

    public static void encodeBinary(Binary data, StreamInterface stream) throws IOException {
        stream.write(Utils.toBytes(109));
        stream.write(Utils.packNumber(data.mData.length));
        stream.write(data.mData);
    }

    public static void encodeString(String data, StreamInterface stream) throws IOException {
    ...
    public static void encodeNewReference(NewReference data, StreamInterface stream) throws IOException {
    ...
    public static void encodeErlFunction(ErlFunction data, StreamInterface stream) throws IOException {
    ...
    public static void encodeNewFunction(NewFunction data, StreamInterface stream) throws IOException {
    ...
    public static void encodeExport(Export data, StreamInterface stream) throws IOException {
    ...
    public static void encodeList(List<Object> data, StreamInterface stream) throws IOException {
    ...
    public static void encodeMap(Map<Object, Object> data, StreamInterface stream) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            value = data.get(key);
            propList.add(
                new Tuple().append(key).append(value)
            );
        }
    ...
    public static void encode(Object data, StreamInterface stream) throws IOException {
    ...
    public static void encode(Object data, StreamInterface stream, Boolean sendMagicByte) throws UnsupportedOperationException, IOException {
        ...
        if      (dc == Float.class)        { encodeDouble(((Float) data).doubleValue(), stream); }
        else if (dc == Double.class)       { encodeDouble((Double) data, stream); }
        else if (dc == BitBinary.class)    { encodeBitBinary((BitBinary) data, stream); }
        else if (dc == AtomCacheRef.class) { encodeAtomCacheRef((AtomCacheRef) data, stream); }
        else if (dc == Byte.class)         { encodeByte((Byte) data, stream); }
        else if (dc == Short.class)        { encodeShort((Short) data, stream); }
        else if (dc == Integer.class)      { encodeInteger((Integer) data, stream); }
        else if (dc == Long.class)         { encodeLong((Long) data, stream); }
        else if (dc == BigInteger.class)   { encodeBigInteger((BigInteger) data, stream); }
        else if (dc == Atom.class)         { encodeAtom((Atom) data, stream); }
        else if (dc == Reference.class)    { encodeReference((Reference) data, stream); }
        else if (dc == Port.class)         { encodePort((Port) data, stream); }
        else if (dc == Pid.class)          { encodePid((Pid) data, stream); }
        else if (dc == Tuple.class)        { encodeTuple((Tuple) data, stream); }
        else if (dc == Nil.class)          { encodeNil((Nil) data, stream); }
        else if (dc == String.class)       { encodeString((String) data, stream); }
        else if (dc == Binary.class)       { encodeBinary((Binary) data, stream); }
        else if (dc == NewReference.class) { encodeNewReference((NewReference) data, stream); }
        else if (dc == ErlFunction.class)  { encodeErlFunction((ErlFunction) data, stream); }
        else if (dc == NewFunction.class)  { encodeNewFunction((NewFunction) data, stream); }
        else if (dc == Export.class)       { encodeExport((Export) data, stream); }
        else if (data instanceof List)     { encodeList((List<Object>) data, stream); }
        else if (data instanceof Map)      { encodeMap((Map<Object, Object>) data, stream); }
        else {
            throw new UnsupportedOperationException(
                dc.getName() + " is not Erlang serializable!"
            );
        }
    }
}
